...
const eventName = 'khi nhớ em';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc honey của anh một ngày tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
